...
public class ZigguratExponentialSamplerTest {
    ...
    public void testSharedStateSampler() {
        ...
        final ZigguratExponentialSampler sampler1 = ZigguratExponentialSampler.of(rng1);
        final ZigguratExponentialSampler sampler2 = sampler1.withUniformRandomProvider(rng2);
    ...
    public void testSharedStateSamplerWithMean() {
        ...
        final ZigguratExponentialSampler sampler1 = ZigguratExponentialSampler.of(rng1, mean);
        final ZigguratExponentialSampler sampler2 = sampler1.withUniformRandomProvider(rng2);
        RandomAssert.assertProduceSameSequence(sampler1, sampler2);
    }
}
