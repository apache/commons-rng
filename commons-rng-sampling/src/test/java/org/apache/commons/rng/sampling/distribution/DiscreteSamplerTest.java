...
/**
 * Tests the default methods in the {@link DiscreteSampler} interface.
 */
class DiscreteSamplerTest {
    ...
    void testSamples() {
        ...
        final DiscreteSampler s1 = RandomSource.SPLIT_MIX_64.create(seed)::nextInt;
        final DiscreteSampler s2 = RandomSource.SPLIT_MIX_64.create(seed)::nextInt;
     ...
     * @return the samples
     */
    private static int[] createSamples(DiscreteSampler sampler, int count) {
