...
public class XoShiRo512StarStar extends AbstractXoShiRo512 {
     ...
     */
    public XoShiRo512StarStar(final long[] seed) {
        super(seed);
    }
     ...
     */
    public XoShiRo512StarStar(final long seed0, final long seed1, final long seed2, final long seed3,
     ...
     */
    protected XoShiRo512StarStar(final XoShiRo512StarStar source) {
        super(source);
    }
