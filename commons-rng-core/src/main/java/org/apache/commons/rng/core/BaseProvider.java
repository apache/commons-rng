...
public abstract class BaseProvider
     ...
     *         super(seed = ensureSeedLength(seed, 123));
     ...
     * is not possible as it is an instance method. Calling a seed expansion routine must use a
     * static method.
     *
     * <p>This method functions as if the seed has been expanded using a
     ...
     * </pre>
     *
     * <p>Any seed expanded by this method will have a maximum of one occurrence of zero
     ...
     *
     * <p>This method functions as if the seed has been expanded using a
     * {@link org.apache.commons.rng.core.source64.SplitMix64 SplitMix64}-style
     ...
     * @return the seed
     */
    protected static int[] ensureSeedLength(int[] seed, int length) {
        if (seed.length < length) {
