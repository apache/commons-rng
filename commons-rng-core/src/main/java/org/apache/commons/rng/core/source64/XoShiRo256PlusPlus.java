...
public class XoShiRo256PlusPlus extends AbstractXoShiRo256 {
     ...
     */
    public XoShiRo256PlusPlus(final long[] seed) {
        super(seed);
    }
     ...
     */
    public XoShiRo256PlusPlus(final long seed0, final long seed1, final long seed2, final long seed3) {
     ...
     */
    protected XoShiRo256PlusPlus(final XoShiRo256PlusPlus source) {
        super(source);
    }
